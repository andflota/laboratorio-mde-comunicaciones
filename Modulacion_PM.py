...
from EnvolventeCompleja_PM import EnvolventeCompleja_PM  # grc-generated hier_block
...
class Modulacion_PM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._G_T_X_range = Range(0, 30, 1, 1, 200)
        self._G_T_X_win = RangeWidget(self._G_T_X_range, self.set_G_T_X, "Ganancia Del Transmisor", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._Ac_range = Range(0, 2, 0.000001, 0.25, 200)
        ...
        self.EnvolventeCompleja_PM_0 = EnvolventeCompleja_PM(
            Ac=Ac,
            Kp=Kp,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.EnvolventeCompleja_PM_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.EnvolventeCompleja_PM_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.EnvolventeCompleja_PM_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.EnvolventeCompleja_PM_0, 0))
    ...
    def set_Kp(self, Kp):
        self.Kp = Kp
        self.EnvolventeCompleja_PM_0.set_Kp(self.Kp)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.EnvolventeCompleja_PM_0.set_Ac(self.Ac)
